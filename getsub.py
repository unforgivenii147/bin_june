...
class SubtitleDownloader:
    ...
    def download_srt_from_url(self, url):
        ...
        try:
            ...
            if response.status_code == 200:
                # Check if it's SRT content
                content = response.text
                if content and ("1\n00:00:" in content or "WEBVTT" in content):
                    return content

                # If it's a ZIP, we can't handle it easily, try alternative source
    ...
    def download_subtitles(self, query):
        """Main method to download subtitles"""
