...
def remove_old_commits(repo_path=".", days=30):
    """
    Remove commits older than specified days from git history.

    Args:
        repo_path: Path to the git repository
        days: Number of days to keep (commits newer than this)
    """
...
def remove_commits_older_than_days(repo_path=".", days=30, auto_confirm=False):
    """
    Simplified version that removes commits and squashes history.
    Creates a new branch with only recent commits.
    """
