...
def inspect_and_move_wheels(root_dir="."):
    ...
    for whl_path in wheel_files:
        # Prevent the script from scanning wheels already moved into the suspicious folder
        ...
        try:
            with zipfile.ZipFile(whl_path, "r") as archive:
                ...
                for name in namelist:
                    ...
                    # Identify files residing directly in the root of the ZIP
                    if "/" not in name:
                ...
                if loose_root_files:
                    ...
                    # Create target directory dynamically if a bad wheel is found
