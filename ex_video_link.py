...
def extract_zzztube_link(zzztube_url: str) -> dict:
    """
    Extract video link and metadata from a zzztube URL.

    Args:
        zzztube_url: Full URL to a zzztube page (e.g., https://zzztube.com/123456789)

    Returns:
        Dictionary with video_id, title, and playable URLs
    """
    headers = {
    ...
    # Method 1: Extract from config JSON in script tag
    config_json = None
    ...
    # Method 2: Extract video ID from URL or data attributes
    video_id = None
    ...
    # Extract iframe source if available
...
def save_results_to_file(
    ...
    """
    Save extracted video links to a JSON file using pathlib.

    Args:
        results: Dictionary with extracted video data
