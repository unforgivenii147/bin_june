...
class PackageDetector:
    ...
    def detect_package_type(self, package_dir: Path) -> tuple[bool, bool, bool]:
        """Detect if package has C extensions or binary files."""
    ...
    def read_dist_info(dist_info_dir: Path) -> dict[str, str]:
        ...
        if metadata_file.exists():
            try:
                ...
                # Logging would go here if we had a logger
                pass
        return metadata
...
class WheelBuilder:
    ...
    def create_record(self, wheel_path: Path, dist_info_dir: str) -> str:
        """Create RECORD file for the wheel."""
        records = []
...
class VenvRepacker:
    ...
    def find_packages(self) -> list[str]:
        """Find all packages in site-packages."""
    ...
    def repack_all(self) -> dict:
        """Repack all packages found in site-packages."""
        print("\n╔════════════════════════════════════════════════════════════╗")
    ...
    def print_stats(self) -> None:
        """Print statistics about the repacking process."""
        print("\n" + "=" * 60)
        print("STATISTICS")
        print("=" * 60)
    ...
    def list_wheels(self) -> None:
        """List all generated wheel files."""
