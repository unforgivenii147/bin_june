...
MAX_WORKERS: Final[int] = 1  # Kept as 1 as per original code, likely to avoid rate limits
...
def chunk_file(file_path: Path, chunk_size: int = CHUNK_SIZE) -> list[tuple[int, int, str]]:
    """Splits a file into chunks based on character count while respecting line boundaries."""
    chunks = []
    current_chunk = []
    current_size = 0
    start_line = 0
