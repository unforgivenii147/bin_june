...
def merge_translation_files(base_dir=".", output_file="dic.json", failed_file="failed.txt"):
    """
    Merge numbered translation file pairs (01, 01_fa) into a single JSON dictionary.
    Filters out entries where Persian translation equals English word.

    Args:
        base_dir: Directory containing translation files (default: current directory)
        output_file: Output JSON filename
        failed_file: Output file for untranslated entries
    """
